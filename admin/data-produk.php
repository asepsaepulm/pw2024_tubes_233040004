				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo ($row['product_status'] == 0)? 'No Active':'Active'; ?></td>
							<td>
								<a href="edit-produk.php?id=<?php echo $row['product_id'] ?>">Edit</a> || <a href="proses-hapus.php?idp=<?php echo $row['product_id'] ?>" onclick="return confirm('are you sure you want to delete it?')">Delete</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
